...
<div class="col-sm-6">
	...
	<div class="media">
	  ...
	  <div class="media-body">
	    <h4 class="media-heading">Hampus Axelsson</h4>
	...
	<div class="media">
	  ...
	  <div class="media-body">
	    ...
	    <p>Bor på ett fett najs studentboende. Gör resten av webblaget avundsjuka. Kommer från Gotland, där finns det får. Rätt stor Ö ändå. Rauuukar. Jättelång text tänkte jag att detta skulle va, men jag kommer inte på mer roliga saker att skriva. Connie har samma efternamn som Alfons, Alfons Åberg!</p>
	  </div>
	</div>
	<div class="media">
	  <a class="pull-left" href="#">
