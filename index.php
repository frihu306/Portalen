	  ...
	  <div id="page-container">
		  ...
		  <div id="content">
			 ...
			 <div class="top-div"></div>
   		 	 <div class="row">
				 <div class="col-sm-12">
				 	<h5 style="font-weight: 200;">Idag på Trappan</h5>
			 	 </div>
				 <div class="col-sm-4">
					 <div class="upcoming-event">
						 <strong>Vinterkravallen</strong><br /> 23 maj 18.00 - 03.00
					 </div>
				 ...
				 <div class="col-sm-4">
					 <div class="upcoming-event">
						 <strong>Vinterkravallen</strong><br /> 23 februari 18.00 - 03.00
					 </div>
					 <div class="upcoming-event-info" style="overflow: hidden;">
						 <small><p style="float: left;">Lediga pass <br /><strong>2/16</strong></p>
						 <p style="float: right">Arrangemangstyp <br /><strong>Annorlunda pubkväll</strong></p></small>
				 ...
				 <div class="col-sm-4">
					 <div class="upcoming-event">
						 <strong>Vinterkravallen</strong><br /> 23 november 18.00 - 03.00
					 </div>
					 <div class="upcoming-event-info" style="overflow: hidden;">
						 <small><p style="float: left;">Lediga pass <br /><strong>2/16</strong></p>
						 <p style="float: right">Arrangemangstyp <br /><strong>Annorlunda pubkväll</strong></p></small>
